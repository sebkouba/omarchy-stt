...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    match client.complete(simple_prompt, "Turn off the LEDs", "test") {
    ...
    match client.complete(formatted_prompt, "Turn off the LEDs", "test") {
        Ok(result) => println!("✅ {} (tool_called: {})\n", result.text, result.tool_called),
        Err(e) => println!("❌ Error: {}\n", e),
    }
    ...
    match client.complete(medium_prompt, "Turn off the LEDs", "test") {
        Ok(result) => println!("✅ {} (tool_called: {})\n", result.text, result.tool_called),
        Err(e) => println!("❌ Error: {}\n", e),
    }
