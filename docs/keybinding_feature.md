...
```ini
bind = SUPER SHIFT CTRL ALT, Q, exec, /home/seb/code/cloned/transcribe-rs-v2/ptt-test.sh start
bindr = SUPER SHIFT CTRL ALT, Q, exec, /home/seb/code/cloned/transcribe-rs-v2/ptt-test.sh stop
```
...
bindri = , Q, exec, /home/seb/code/cloned/transcribe-rs-v2/ptt-test.sh stop
```
